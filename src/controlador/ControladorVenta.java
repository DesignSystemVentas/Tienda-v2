...
public class ControladorVenta {
    ...
    public ResultSet llenarVenta() throws ErrorTienda{
         try  {
             ...
             return (cn.getValores("SELECT IdVenta, IdSucursal, TipoVenta, IdTipoPrecio, Cliente, Fecha, IVA, TotalGravado, Total, Direccion, Giro, NIT, NRC, NDocumento FROM venta"));
   ...
   public void Agregar(int IdVenta, int IdSucursal, String TipoVenta, int IdTipoPrecio, String Cliente, 
           ...
           String NIT, int NRC, int NDocumento) throws ErrorTienda{
             try {         
             Conexion cn = new Conexion();
