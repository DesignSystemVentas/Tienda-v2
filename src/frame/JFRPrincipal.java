...
public final class JFRPrincipal extends javax.swing.JFrame {
    ...
    int dia, mes, anio, fila=0, venta=0, sucursal, tipoventa;   
    ...
    String datosVenta[] = new String[14], CodigoBarraVender = "";;
    boolean encontrar;
    //vaizcarra//
    ...
    public JFRPrincipal() {                
        ...
        MenuVenta.addColumn("IdSucursal");
        MenuVenta.addColumn("TipoVenta");
        MenuVenta.addColumn("IdTipoPrecio");
        MenuVenta.addColumn("Cliente");
        MenuVenta.addColumn("Fecha");
        MenuVenta.addColumn("IVA");
        MenuVenta.addColumn("TotalGravado");
        MenuVenta.addColumn("Total");
        MenuVenta.addColumn("Direccion");
        MenuVenta.addColumn("Giro");
        MenuVenta.addColumn("NIT");
        MenuVenta.addColumn("NRC");
...
/*  ---- Visualización de imágenes en Menú ----  */
    ...
    private void initComponents() {
        ...
        jpnMenuVentas.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 250, 740, 190));
        ...
        jpnMenuVentas.add(btnHacerNuevaVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 460, 110, 30));
        ...
        jpnMenuVentas.add(jPanel44, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 760, 70));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ENERO", "FEBRERO", "MARZO", "ABRIL", "MAYO", "JUNIO", "JULIO", "AGOSTO", "SEPTIEMBRE", "OCTUBRE", "NOVIEMBRE", "DICIEMBRE", " " }));
        jpnMenuVentas.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 100, 40));

        jLabel44.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel44.setText("Generar Reporte");
        jpnMenuVentas.add(jLabel44, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 110, -1));

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/buscar48.png"))); // NOI18N
        jpnMenuVentas.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 130, 100, 40));

        jLabel52.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel52.setText("Fecha de Venta");
        jpnMenuVentas.add(jLabel52, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 110, -1));
        ...
        jpnRegistrarVenta.add(jSeparator44, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 220, 750, 10));
        ...
        jpnRegistrarVenta.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 710, 190));
        ...
        jpnRegistrarVenta.add(btnVender, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 490, 110, 30));

        txtNombreProductoVender.setEditable(false);
        txtNombreProductoVender.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jpnRegistrarVenta.add(txtNombreProductoVender, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, 270, 40));

        txtCantidadVender.setText("  1");
        txtCantidadVender.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jpnRegistrarVenta.add(txtCantidadVender, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 120, 70, 40));
        ...
        jpnRegistrarVenta.add(btnAgregarProductoVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 175, 110, 30));
        ...
        jPanel49.add(jSeparator45, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 0, 20, 70));
        ...
        jPanel49.add(lblProveedores7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 190, 50));

        jLabel40.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel40.setForeground(new java.awt.Color(255, 255, 255));
        jLabel40.setText("ID Venta");
        jPanel49.add(jLabel40, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 10, 70, -1));
        ...
        jPanel49.add(txtClienteVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 30, 280, 30));

        jLabel41.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel41.setForeground(new java.awt.Color(255, 255, 255));
        jLabel41.setText("Cliente");
        jPanel49.add(jLabel41, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 10, 70, -1));
        ...
        jPanel49.add(txtIdVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 30, 140, 30));
        ...
        jpnRegistrarVenta.add(jPanel49, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 730, 70));

        jLabel42.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel42.setText("Producto");
        jpnRegistrarVenta.add(jLabel42, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 100, -1, -1));

        jLabel43.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel43.setText("Tipo Factura");
        jpnRegistrarVenta.add(jLabel43, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 100, -1, -1));
        ...
        jpnRegistrarVenta.add(txtCodigoBarraVender, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 120, 120, 40));

        jLabel45.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel45.setText("Utilidad");
        jpnRegistrarVenta.add(jLabel45, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, -1, -1));

        cmbTipoFactura.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CONSUMIDOR FINAL", "CREDITO FISCAL", "LIBRE" }));
        jpnRegistrarVenta.add(cmbTipoFactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 120, 130, -1));
        ...
        jpnRegistrarVenta.add(cmbSucursal, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 120, -1));

        jLabel46.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel46.setText("Código de Barra");
        jpnRegistrarVenta.add(jLabel46, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, -1, -1));

        jLabel47.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel47.setText("Cantidad");
        jpnRegistrarVenta.add(jLabel47, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 100, -1, -1));

        txtPercepcion.setEditable(false);
        txtPercepcion.setBackground(new java.awt.Color(255, 255, 255));
        txtPercepcion.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jpnRegistrarVenta.add(txtPercepcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 510, 90, 20));

        lblIVA.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblIVA.setText("IVA");
        jpnRegistrarVenta.add(lblIVA, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 480, -1, -1));
        jpnRegistrarVenta.add(txtIVA, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 480, 90, -1));

        jLabel48.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel48.setText("SUMAS");
        jpnRegistrarVenta.add(jLabel48, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 450, -1, -1));
        jpnRegistrarVenta.add(txtSumas, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 450, 90, -1));

        jLabel49.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel49.setText("TOTAL");
        jpnRegistrarVenta.add(jLabel49, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 540, -1, -1));
        ...
        jpnRegistrarVenta.add(txtTotalventaGravado, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 540, 90, 20));

        jLabel50.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel50.setText("PERCEPCIÓN");
        jpnRegistrarVenta.add(jLabel50, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 510, -1, 20));

        jLabel51.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel51.setText("Sucursal");
        jpnRegistrarVenta.add(jLabel51, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, -1, -1));

        jpnRegistrarVenta.add(cmbUtilidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 120, -1));
        ...
        jpnReporteVentas.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 220, 750, 10));
        ...
        jpnReporteVentas.add(jScrollPane8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 250, 740, 190));
    ...
    private void btnVentasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVentasMouseClicked
        ...
        try {
            while (rstControladorVenta.next()) {//tablas base de datos
                ...
                datosVenta[4] = rstControladorVenta.getString(5);
                datosVenta[5] = rstControladorVenta.getString(6);
                datosVenta[6] = rstControladorVenta.getString(7);
                datosVenta[7] = rstControladorVenta.getString(8);
                datosVenta[8] = rstControladorVenta.getString(9);
                datosVenta[9] = rstControladorVenta.getString(10);
                datosVenta[10] = rstControladorVenta.getString(11);
                datosVenta[11] = rstControladorVenta.getString(12);
                datosVenta[12] = rstControladorVenta.getString(13);
                datosVenta[13] = rstControladorVenta.getString(14);
    ...
    private void btnHacerNuevaVentaMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnHacerNuevaVentaMouseEntered
        btnHacerNuevaVenta.setIcon(new ImageIcon(getClass().getResource("/iconos/venderB.png")));
    ...
    private void btnHacerNuevaVentaMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnHacerNuevaVentaMouseExited
        btnHacerNuevaVenta.setIcon(new ImageIcon(getClass().getResource("/iconos/vender.png")));
    ...
    private void btnAgregarProductoVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarProductoVentaActionPerformed
       ...
       if (posicioncmbTipoFactura==0) {          
        ...
        TotalVenta = TotalVenta +(SubTotalVenta);
                ...
                Punitario= ((Punitario/(1-0.25)))*0.13;
                SubTotalVenta = Punitario * (Double.parseDouble(txtCantidadVender.getText()));
        TotalVenta = TotalVenta +(SubTotalVenta);
            } if (posicioncmbSucursal==2) {
                Punitario= ((Punitario/(1-0.085)))*0.13;
                SubTotalVenta = Punitario * (Double.parseDouble(txtCantidadVender.getText()));
        TotalVenta = TotalVenta +(SubTotalVenta);
            }  
...
//hacer que al dar clip se pase al txtCodigoBarraVender
       ...
       //FILAZADO (TIPO FACTURA)//
//***************************************************************************//
       //INICIA CREDITO  FISCAL//
...
//hacer que al dar clip se pase al txtCodigoBarraVender
       ...
       NuevoValor = (Punitario * Double.parseDouble(txtCantidadVender.getText())) + (Double.parseDouble(tblRegistrarVenta.getValueAt(j-1, 4).toString()));
        ...
        txtTotalventaGravado.setText("$"+total);
        txtPercepcion.setText("$"+TotalGravadoFiscalP);
       }
...
//hacer que al dar clip se pase al txtCodigoBarraVender
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        int sucursaldv = cmbSucursal.getSelectedIndex();
        sucursaldv = sucursaldv+1;
        ...
        String Direcion="", Giro="", NIT="";
        int NRC=0, NDocumento=0;
        int IdVenta = venta;
        int IdSucursal = sucursal + 1;
        String TipoVenta = String.valueOf(cmbTipoFactura.getSelectedIndex() + 1);
        int IdTipoPrecio = cmbUtilidad.getSelectedIndex() + 1;
        ...
        if (cmbTipoFactura.getSelectedIndex()==0) {
             int filas = tblRegistrarVenta.getRowCount(), iteracion=0;        
        while (iteracion<filas){
            TotalGravado = TotalGravado + Double.parseDouble(String.valueOf(tblRegistrarVenta.getValueAt(iteracion, 4)));
            iteracion++;             
        }
...
//        txtTotalventaGravado.setText("");
//        
//        int filas = mAgregarDVenta.getRowCount(), iteracion=0;
//        double total=0;
//        while (iteracion<filas){
//            total+=Double.parseDouble(String.valueOf(mAgregarDVenta.getValueAt(iteracion, 4)));
//            iteracion++;
//        }
